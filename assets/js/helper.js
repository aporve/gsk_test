        ...
        return `
            <div class="profile_section" tabindex=0>
                <div class="block">
                    ...
                    <!-- <div class="icon"><img class="arrow-down" src="/gsk_test/assets/images/svg/down.svg" /></div> -->
                </div>
...
function showDatePicker() {
    ...
    return `
        <div class="flex calendar-picker">
            <img class="picker" src="/gsk_test/assets/images/svg/calendar.svg" />
            <input type='text' id='tbDate' placeholder='${locale["labels"]["pickDate"]}' readonly="readonly" />
            <img class="arrow-down" src="/gsk_test/assets/images/svg/down.svg" />
        </div>
    `;
}
...
function showDatePickerWhite(date) {
    ...
    return `
        <div class="flex calendar-picker">
            <img class="picker" src="/gsk_test/assets/images/svg/calendar-white.svg" />
            <input type='text' id='tbDate' placeholder='${date ? date : locale["labels"]["pickDate"]}' readonly="readonly"></input>
            <!-- <img class="arrow-down" src="/gsk_test/assets/images/svg/down-white.svg" /> -->
        </div>
    `;
}
